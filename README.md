...
Zacząłem od wyszukania odpowiednich punktów odpowiadającym moim inicjałom. 
```
...
Następnie dodałem moją silnie oraz funkcję pomocniczą do rysowania naszych krzywych beziera. 
